  ...
  const Navbar = () => {
    return (
      <div className='border-x-2 mx-auto lg:w-[1080px] max-[640px]:w-full sticky top-0 z-10 bg-white'>
        ...
        <h1 className='pl-[18px] text-[12px] max-[640px]:hidden'>ONLINE ACCOUNT OPENING PORTAL</h1>
