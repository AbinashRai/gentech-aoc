...
export default function Home() {
  return (
    <div className=" lg:w-[1080px] mx-auto bg-slate-100 lg:h-screen md:h-fit">
      <div className="max-[1024px]:w-[83%] lg:w-[928px] mx-auto h-[553px] flex justify-between max-[640px]:block">
        ...
        <div className="w-[360px] lg:w-[436px]  md:w-[272px] max-[640px]:w-full">
          <div className="lg:h-[470px] md:h-[366px] md:mt-[43px] lg:mt-[62px] bg-white rounded-2xl sm:w-[274px] md:w-[272px] lg:w-[436px]">
            <div className="lg:h-[392px] md:h-[324px] pt-[7px] border-b-2 w-[274px] lg:w-[371px] md:w-[238px]  mx-auto">
              <img
                ...
                alt="home-image"
              />
              <div className="mx-auto w-[200px] lg:w-[297px] md:w-[238px]  text-zinc-500 pt-[19px] text-[13px] md:text-[14px] lg:text-[15px]">
                <p>
                ...
                <div className="mx-auto">
                  <Link
                    className="flex mx-auto text-[10px] md:text-[14px]  bg-[#F03738] text-white w-[130px] md:w-[194px] h-[40px] rounded-lg md:mb-[35px] md:mt-[25px] lg:mb-[55px] lg:mt-[36px]"
                    href="/">
